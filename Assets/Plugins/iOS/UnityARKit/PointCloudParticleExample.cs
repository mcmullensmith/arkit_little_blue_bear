...
public class PointCloudParticleExample : MonoBehaviour {
	...
	void Update () {
        quality = UnityARSessionNativeInterface.GetARSessionNativeInterface().GetARTrackingQuality();
        if (frameUpdated) {
            ...
            switch(quality) {
                case 0:
                    qualityText.text = "Tracking is not available";
                    break;
                case 1:
                    qualityText.text = "Tracking is limited";
                    break;
                case 2:
                    qualityText.text = "Tracking is normal";
                    break;
                default:
                    qualityText.text = "";
                    break;
